...
export default {
    ...
    // created(){
    //     this.interval = setInterval(() => this.updateVal() , 100)
    // },
    mounted() {
        // if(localStorage.stacker){
        //     this.stacker = localStorage.stacker
        // }
    },
    created() {
